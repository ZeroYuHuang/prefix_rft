...
if __name__ == "__main__":
    data_files = "/mnt/jfs2/cth/085b13/_data/raw_dataset/distillation/luffy_train//luffy_train_r1_distill_7b_unverified.jsonl"
    ...
    num_demo_fig_path = "/data/stat_num_demo_luffy_train_distill_7b_distribution.png"
    ...
    plt.ylabel('Count')
    plt.grid(axis='y', alpha=0.75)
    avg_correctness_fig_path = "/data/stat_avg_correctness_luffy_train_distill_7b_distribution.png"
    ...
    dataset_name = "luffy_train_distill7b_sys_wo_format_all_8k"
    ...
    dataset_name = "luffy_train_distill7b_sys_wo_format_all_8k_correct"
    save_dir = f"{HOME_DIR}/_data/processed_dataset_new/{dataset_name}"
    print(f"Save to {save_dir}/train.parquet")
    dataset.to_parquet(os.path.join(save_dir, f'train.parquet'))
