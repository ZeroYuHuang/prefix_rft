...
def reward_fn_standard(solution_str, ground_truth, extract=0):
    """
    ...
    if final_answer == "":
        return 0.0
    ans_parsed, gold_parsed = solution2answer(final_answer), solution2answer(ground_truth)
    iscorrect = is_equal(ans_parsed, gold_parsed)
    score = 1.0 if iscorrect else 0.0
    return score, ans_parsed, gold_parsed
